...
export const content: Content = {
  ...
  cta: {
    ...
    statistics: [
      ...
      "<strong>Гораздо больше</strong> — подверглись избиениям и сексуализированному насилию.",
      "И ситуация становится только хуже.",
      "<strong>В 2023 году каждые 10 минут партнер или член семьи убивал женщину.</strong>"
    ],
    mainText: []
  },
  ...
  hero: {
    ...
    subtitle: "В 2023 году каждые 10 минут партнер или член семьи убивал женщину.",
    buttons: {
